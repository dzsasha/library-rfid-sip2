...
namespace IS.SIP2.CS.SIP2 {
    ...
    public class CheckOutResponseImpl : Sip2ResponsePrintImpl, ICheckOutResponse {
        ...
        /// валюта
        /// </summary>
        [Sip2Field(12, Length = 3, Version = Sip2Version.V200, Description = "валюта", Identificator = "BH")]
        ...
        /// дата возврата
        /// </summary>
        [Sip2Field(10, Required = true, Description = "дата возврата", Identificator = "AH", SerializeType = typeof(DueDateSerialize))]
        ...
        /// тип взноса
        /// </summary>
        [Sip2Field(11, Length = 2, SerializeType = typeof(ItemInformationResponseImpl.Sip2FeeTypeImpl), Version = Sip2Version.V200, Identificator = "BT", Description = "тип взноса")]
        ...
        /// тип носителя
        /// </summary>
        [Sip2Field(15, Identificator = "CK", SerializeType = typeof(ItemInformationResponseImpl.Sip2MediaTypeImpl), Version = Sip2Version.V200, Description = "тип носителя", Length = 3)]
        public Sip2MediaType MediaType { get; set; }
        /// <summary>
        /// разрешено
        /// </summary>
        [Sip2Field(1, Required = true, Description = "разрешено", SerializeType = typeof(OkCheckOutSerialize))]
        ...
        /// </summary>
        [Sip2Field(2, Required = true, Description = "возобновление разрешено")]
