...
namespace IS.SIP2.CS.SIP2
{
    ...
    {
        public class OkRenewSerialize : Sip2SerializeImpl {
        ...
        public class DueDateRenewSerialize : Sip2SerializeImpl {
            public override string Serialize(Sip2FieldAttribute field, object value, Char separator) {
        ...
        /// дата возврата
        /// </summary>
        [Sip2Field(Required = true, Length = 18, Description = "дата возврата", Identificator = "AH", SerializeType = typeof(DueDateRenewSerialize), Order = 10)]
        ...
        /// тип взноса
        /// </summary>
        [Sip2Field(Length = 2, SerializeType = typeof(Sip2FeeTypeImpl), Version = Sip2Version.V200, Identificator = "BT", Description = "тип взноса", Order = 11)]
        ...
        /// разрешено
        /// </summary>
        [Sip2Field(1, 1, Required = true, Description = "разрешено", SerializeType = typeof(OkRenewSerialize))]
