    ...
    public partial class TypeCtrl : UserControl {
        ...
        private void cbId_SelectedIndexChanged(object sender, EventArgs e) {
            if (sender is ComboBox) {
                if ((sender as ComboBox).SelectedItem is IItemEx) {
                    this.cbEAS.CheckedChanged -= cbEAS_CheckedChanged;
                    cbEAS.Checked = ((sender as ComboBox).SelectedItem as IItemEx).Eas;
                    this.cbEAS.CheckedChanged += this.cbEAS_CheckedChanged;
                }
                else {
                    cbEAS.Enabled = false;
                }
        ...
        private void cbEAS_CheckedChanged(object sender, EventArgs e) {
            if (cbId.SelectedItem is IItemEx) {
                (cbId.SelectedItem as IItemEx).Eas = (sender as CheckBox).Checked;
            } else {
